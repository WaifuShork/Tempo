...
namespace OpenTKRendering.Shaders
{
    public class Shader
    {
        ...
        private static void LinkProgram(int program)
        {
            ...
            GL.GetProgram(program, GetProgramParameterName.LinkStatus, out var statusCode);

            if (statusCode != (int) All.True)
            {
                throw new Exception($"Error occurred whiles linking Program({program})");
            }
        }
