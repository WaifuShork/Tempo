...
using OpenTKRendering.Shaders;

namespace OpenTKRenderer.Windowing
{
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            _lightingShader = new Shader("src/Shaders/shader.vert", "src/Shaders/lighting.frag");
            _lampShader = new Shader("src/Shaders/shader.vert", "src/Shaders/shader.frag");
            ...
            _diffuseMap = Texture.LoadFromFile("src/Resources/container2.png");
            _specularMap = Texture.LoadFromFile("src/Resources/container2_specular.png");
